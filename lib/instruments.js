 ...
 * @return {Bool}
 */
exports.hasWorkMetric = function(label) {
 ...
 * @return {Bool}
 */
exports.hasEventMetric = function(label) {
 ...
 * @return {Bool}
 */
exports.hasGaugeMetric = function(label) {
...
/**
 * startWork function.
 * Starts a StatsD work timer, and returns the mutated callback that causes the timer to be stopped.
 * @return {Function} The mutated callback function that stops the work timer before being invoked.
 */
